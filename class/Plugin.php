...
class Plugin
{
  const PLUGINS_TITLE = 'Cart2cart: Loaded Commerce to Woocommerce Plugin';
  ...
  const URL_LIMIT = 'from-loadedcommerce-to-woocommerce';
  const SOURCE_CART_ID = 'LoadedCommerce';
